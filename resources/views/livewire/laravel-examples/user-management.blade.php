<div class="main-content">
    <div class="alert alert-secondary mx-4" role="alert">
        <span class="text-white"><strong>Listado de Rutinas</strong>, Creación de Rutinas
            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        <div>
                            <h5 class="mb-0">Rutinas</h5>
                        </div>
                        <a href="#" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; Crear Rutinas nuevas</a>
                    </div>
                </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Cardio</p>
                                    </td>
                                    <!-- <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Piernas</p>
                                    </td>
                                    <!-- <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Pecho</p>
                                    </td>
                                    <!-- <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Espalda</p>
                                    </td>
                                    <!-- <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">Mixto</p>
                                    </td>
                                    <!-- <td class="text-center">
