        ...
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit.prevent="save" action="#" method="POST" role="form text-left">
                            ...
                            <div class="form-group">
                                ...
                                <div class="@error('user.location') border border-danger rounded-3 @enderror">
                                    <input wire:model="user.location" class="form-control" type="text"
                                        placeholder="dirección del Usuario" id="name">
                                </div>
                    ...
                    <div class="form-group">
                        <label for="about">{{ 'Enfermedades o caracteristicas importantes del usuario' }}</label>
                        <div class="@error('user.about')border border-danger rounded-3 @enderror">
                            <textarea wire:model="user.about" class="form-control" id="about" rows="3"
                                placeholder="Información importante del usuario, antes de realizar ejercicio"></textarea>
                        </div>
                        @error('user.about') <div class="text-danger">{{ $message }}</div> @enderror
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Grabar Usuario' }}</button>
                    </div>
                </form>
