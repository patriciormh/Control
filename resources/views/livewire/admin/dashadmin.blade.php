          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Usuario Vencidos</p>
                    <h5 class="font-weight-bolder mb-0">
                      12
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Inscrpciones de día</p>
                    <h5 class="font-weight-bolder mb-0">
                      6
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Pagos del Día</p>
                    <h5 class="font-weight-bolder mb-0">
                      8
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    <p class="mb-1 pt-2 text-bold">Power Fitness Chile</p>
                    <h5 class="font-weight-bolder">Noticias para Socios GYM</h5>
                    <p class="mb-5">Para todos nuestros socios se anuncia que el gimnacio no estara abierto el dia 25 de diciembre por feriado</p>
                ...
                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                  <div class="bg-gradient-warning border-radius-lg h-100">
                    ...
                    <div class="position-relative d-flex align-items-center justify-content-center h-200">
                      <img class="w-100 position-relative z-index-2 pt-4" src="/assets/img/mancuernas.jpg">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('../assets/img/ivancik.jpg');">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">Reglamento de Uso de las Instalaciones</h5>
                <p class="text-white">aquí encontraras las reglas y normas del gimnasio</p>
        ...
        <div class="col-lg-5 mb-lg-0 mb-4">
          <div class="card">
            <div class="card-body p-3">
              ...
              <h6 class="ms-2 mt-4 mb-0"> Actividad Mensual</h6>
                ...
                <div class="row">
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Kilometros Cardio</p>
                    </div>
                  ...
                  <div class="col-3 py-3 ps-0">
                    <div class="d-flex mb-2">
                      ...
                      <p class="text-xs mt-1 mb-0 font-weight-bold">Horas de Rutinas</p>
                    </div>
                    <h4 class="font-weight-bolder">20 horas</h4>
                    <div class="progress w-75">
        ...
        <div class="col-lg-7">
          <div class="card">
            <div class="card-header pb-0">
              <h6>Inscripción Mensual</h6>
              <p class="text-sm">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold">4% mejoramiento</span> in 2022
              </p>
            </div>
            <div class="card-body p-3">
              <div class="chart">
